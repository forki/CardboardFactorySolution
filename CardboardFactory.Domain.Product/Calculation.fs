...
module Calculation =
    ...
    let private calculateSheetLength (product:Product.ProductType, subProduct:Product.SubProduct, corrugationType:Product.CorrugationTypes) = 
        let formula = 
    ...
    let private calculateSheetWidth (product:Product.ProductType, subProduct:Product.SubProduct, corrugationType:Product.CorrugationTypes) = 
        let formula = 
    ...
    let calculateSheetSizes(corrugationType:Product.CorrugationTypes, product:Product.ProductType) =
        product.SubProducts
